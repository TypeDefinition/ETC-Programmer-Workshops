...
//     version 1.14.2
//     from Assets/Example1/Input/GunInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Example1/Input/GunInputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GunInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@GunInputActions()
    {
        UnityEngine.Debug.Assert(!m_Gun.enabled, "This will cause a leak and performance issues, GunInputActions.Gun.Disable() has not been called.");
    }
    ...
    public struct GunActions
    {
        ...
        /// </summary>
        public GunActions(@GunInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
